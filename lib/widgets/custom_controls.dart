...
class _CustomControlsState extends State<CustomControls>
        ...
        child: RawKeyboardListener(
          ...
          onKey: (value) {
            if ((value.logicalKey.keyLabel == 'Arrow Up' ||
                    ...
                    value.logicalKey.keyLabel == 'Arrow Right') &&
    ...
    return GestureDetector(
      ...
      child: DpadContainer(
        ...
        child: CenterPlayButton(
          backgroundColor: isPlaySelected
  ...
  Widget _buildSubtitleToggle() {
    ...
    return GestureDetector(
      ...
      child: DpadContainer(
        onFocus: (isSubFocused) {
          setState(() {
            isSubtitleSelected = isSubFocused;
          });
        },
        onClick: () {
          _onSubtitleTap;
